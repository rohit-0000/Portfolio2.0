  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full flex flex-col md:flex-row gap-5">
        ...
        <a href="mailto:rohit20040121@gmail.com" className="flex gap-2 items-center text-xl">
          <img src={gmail} className="w-8"/>
          <p>rohit20040121@gmail.com</p>
        </a>
        <a href="https://www.linkedin.com/in/rohit-43107a253/" className="flex gap-2 items-center text-xl">
          <img src={linkedin} className="w-8"/>
          <p>rohit-43107a253</p>
        </a>
        <a href="https://github.com/rohit-0000" className="flex gap-2 items-center text-xl">
          <img src={github} className="w-8"/>
          <p>rohit-0000</p>
        </a>

        <a href={resume} download="Rohit-resume.pdf" className="bg-green-500 px-2 py-2 w-fit rounded-md active:scale-90 text-xl">Download CV</a>
        </div>
        <div className="w-full h-full">
          <form onSubmit={handleSubmit(onSubmit)} className="w-full h-full flex flex-col gap-5 text-xl justify-center ">
            <div>
              <input {...register("name", { required: "Name is required" })} className="bg-[#ffffff33] p-2 rounded outline-0 w-full " placeholder="Your name"/>
              {errors.name && <p className="text-sm text-red-500 italic">{errors.name.message}</p>}
            </div>
